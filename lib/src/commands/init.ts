...
export const initCommand = new Command()
  ...
  .action(async (projectName: string | undefined, options: { alias: string; force?: boolean }) => {
    console.log(chalk.blue('🚀 Initializing new Bizmanage project'));
    console.log();
    ...
    try {
      ...
      const gitignoreContent = `# Bizmanage Project
# The local project is the source of truth:
# - Commit src/ and bizmanage.config.json
# - Ignore only local cache/runtime files

# Bizmanage local cache and internal state
.bizmanage/
